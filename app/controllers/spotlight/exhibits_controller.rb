# OVERRIDE Spotlight 3.3.0 to add set_name to params
...
module Spotlight
  ...
  class ExhibitsController < Spotlight::ApplicationController
    ...
    # OVERRIDe here to add set_name to params for Harvard Full Text Search
    def exhibit_params
    ...
    # rubocop:disable Rails/CompactBlank, Rails/Blank
    def create_params
      params.require(:exhibit).permit(
        :title,
        :slug
    ...
    # rubocop:enable Rails/CompactBlank, Rails/Blank
  end
end
