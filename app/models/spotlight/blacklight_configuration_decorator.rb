  ...
  module BlacklightConfigurationDecorator
    def add_exhibit_tags_fields(config)
      ...
      unless config.facet_fields.include? :exhibit_tags
        ...
        config.add_facet_field :exhibit_tags, field: config.document_model.solr_field_for_tagger(exhibit), limit: true, label: I18n.t('spotlight.search.fields.facet.exhibit_tags')
      end
